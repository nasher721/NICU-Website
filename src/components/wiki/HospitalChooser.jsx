    ...
    <section className="hospital-chooser" aria-labelledby="hospital-chooser-heading">
      ...
      <div className="hospital-card-grid">
        {hospitals.map((hospital) => (
          <a className="hospital-card" data-campus={hospital.campus} href={hospital.href} key={hospital.campus}>
            <span className="hospital-card-badge" aria-hidden="true">{hospital.shortName}</span>
            <span className="hospital-card-copy">
              <strong>{hospital.name}</strong>
              <small>{hospital.description}</small>
            </span>
            <span className="hospital-card-action">Open wiki <span aria-hidden="true">↗</span></span>
          </a>
        ))}
      </div>
    </section>
